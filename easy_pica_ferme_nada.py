...
def print_instructions():
  print("This game is a test of your logic and guessing skills. I will generate a three-digit number and you will attempt to guess it. After each guess, I will give you a code:")
...
if answer == "yes":
  print_instructions()
elif answer == "who asked" or answer == "who cares":
...
while(True):
  ...
  if code == "fff":
    ...
    break
  elif code == "ppp" or code == "ffn"  or code == "pfn" or code == "pff" or code == "ppf":
    print("Come on! You're getting close!")
  else:
