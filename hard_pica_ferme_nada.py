...
def print_instructions():
  print("This game is a test of your logic and guessing skills. I will generate a ten-digit number and you will attempt to guess it. After each guess, I will give you a code:")
...
digit_8 = randint(0, 9)
digit_9 = randint(0, 9)
digit_10 = randint(0, 9)
number = [digit_1, digit_2, digit_3, digit_4, digit_5, digit_6, digit_7, digit_8, digit_9, digit_10]
turn_number = 0
for turn in range(2000):
  ...
  if code == "ffffffffff":
    ...
    break
  elif p_count > 6 or f_count > 4 or n_count < 4:
